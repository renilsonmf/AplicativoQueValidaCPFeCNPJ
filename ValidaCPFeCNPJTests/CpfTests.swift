...
class ResultadoCPF: XCTestCase {
    ...
    func testDeveVerificarResultadoDaFuncaoCalculoCPF(){
        ...
        XCTAssertEqual(verificaPenultimoNumero.resultadoCampoDigitado(), "Informe um CPF ou CNPJ válido!" )
        
        let verificaUltimoNumero = CPF(numeroConsultado: "86249075517")
        XCTAssertEqual(verificaUltimoNumero.resultadoCampoDigitado(), "Informe um CPF ou CNPJ válido!")
        
        let verificaNumerosIguaisCpf = CPF(numeroConsultado: "00000000000")
        XCTAssertEqual(verificaNumerosIguaisCpf.resultadoCampoDigitado(), "Informe um CPF válido!")
